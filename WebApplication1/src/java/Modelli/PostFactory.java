...
public class PostFactory {
    ...
    private PostFactory() {
        ...
        post1.setId(1);
        post1.setUtente(utentiFactory.getUtentiRegistratiById(1));
        post1.setPostType(Post.Type.POST_TESTO);

        //Creazione Post 2
        Post post2 = new Post();
        post2.setImage("img/imhacherino.jpg");
        post2.setContent("Ci stanno tracciando, staccaaaaaaaa");
        post2.setId(2);
        post2.setUtente(utentiFactory.getUtentiRegistratiById(2));
        ...
        post3.setId(3);
        post3.setUtente(utentiFactory.getUtentiRegistratiById(3));
